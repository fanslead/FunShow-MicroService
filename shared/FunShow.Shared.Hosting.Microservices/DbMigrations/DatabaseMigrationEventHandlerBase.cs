...
namespace FunShow.Shared.Hosting.Microservices.DbMigrations
{
    ...
    where TDbContext : DbContext, IEfCoreDbContext
    {
        ...
        {
            var tenants = await (await TenantRepository.GetDbSetAsync()).Include(t => t.ConnectionStrings)
            .Where(t => t.ConnectionStrings.Any(cs => cs.Name.Equals("Default"))).ToListAsync();
