...
public class LoggingServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<LoggingServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public LoggingServiceDatabaseMigrationEventHandler(
